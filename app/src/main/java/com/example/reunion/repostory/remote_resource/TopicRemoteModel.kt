...
class TopicRemoteModel:BaseRemoteResource() {
    ...
    suspend fun onInsertReply(commentId: String,replyFloor:Int,fromId:String,toId:String,content: String) = getServiceRemote().onInsertTopicReply(commentId,replyFloor,fromId,toId,content).await()
